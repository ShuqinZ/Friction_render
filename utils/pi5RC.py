...
class pi5RC:
    ...
    def set(self, angle: float, angle_range: float = 180.0, pulse_range: tuple = (5, 24)):
        pulse_width = int(round((angle / angle_range) * (pulse_range[1] - pulse_range[0]) + pulse_range[0])) * 100
