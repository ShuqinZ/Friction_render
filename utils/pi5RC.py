...
class pi5RC:
    def __init__(self, Pin):
        ...
        pwmchip_map = [0, 2, -1, -1, 0, 2]  # GPIO18 (pwmchip2/pwm2), GPIO19 (pwmchip2/pwm1)
        pwmchan_map = [0, 0, -1, -1, 0, 1]
    ...
    def set(self, angle: float, angle_range: float = 180.0, pulse_range: tuple = (500, 2400)):
