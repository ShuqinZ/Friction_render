...
class pi5RC:
    ...
    def set(self, angle: float, angle_range: float = 180.0, pulse_range: tuple = (500, 2400), granularity: int = 10):
        pulse_width = (angle / angle_range) * (pulse_range[1] - pulse_range[0]) + pulse_range[0]
        pulse_width = int(round(pulse_width/granularity)) * granularity
